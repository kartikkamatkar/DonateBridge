     ...
     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="p-5 border border-border rounded-xl flex flex-col items-center justify-between min-h-[160px] bg-slate-50">
       ...
       <div className="text-center mt-4">
        <span className="text-xs font-mono text-slate-400 block font-bold">NAVBAR LOGO</span>
        <button
         onClick={() => handleCopy('<Logo type="navbar" />')}
         className="text-xs font-mono text-primary font-bold hover:underline mt-1 block"
        >
         Copy Component
        </button>
       </div>
      ...
      <div className="p-5 border border-border rounded-xl flex flex-col items-center justify-between min-h-[160px] bg-slate-50">
       ...
       <div className="text-center mt-4">
        <span className="text-xs font-mono text-slate-400 block font-bold">ICON ONLY</span>
        <button
      ...
      <div className="p-5 border border-border rounded-xl flex flex-col items-center justify-between min-h-[160px] bg-slate-50">
       ...
       <div className="text-center mt-4">
        <span className="text-xs font-mono text-slate-400 block font-bold">HORIZONTAL LOGO</span>
        <button
      ...
      <div className="p-5 border border-border rounded-xl flex flex-col items-center justify-between min-h-[160px] bg-slate-50">
       ...
       <div className="text-center mt-4">
        <span className="text-xs font-mono text-slate-400 block font-bold">VERTICAL LOGO</span>
        <button
       ...
       <div className="flex items-center justify-between p-3.5 border border-border rounded-xl">
        <div className="flex items-center gap-3">
         ...
         <div>
          ...
          <p className="text-xs text-slate-400 font-mono">#2E7D32</p>
         </div>
        </div>
       ...
       <div className="flex items-center justify-between p-3.5 border border-border rounded-xl">
        <div className="flex items-center gap-3">
         ...
         <div>
          ...
          <p className="text-xs text-slate-400 font-mono">#43A047</p>
         </div>
        </div>
       ...
       <div className="flex items-center justify-between p-3.5 border border-border rounded-xl">
        <div className="flex items-center gap-3">
         ...
         <div>
          ...
          <p className="text-xs text-slate-400 font-mono">#4CAF50</p>
         </div>
        </div>
     ...
     <div className="saas-card space-y-4">
      ...
      <div className="space-y-4 text-xs">
       <div className="border-b border-border pb-3">
        <span className="text-xs font-mono text-slate-400 uppercase block">Font Family</span>
        <p className="text-sm font-semibold text-slate-900 mt-1">Inter, Geist, Manrope, SF Pro Display</p>
       </div>
       <div className="border-b border-border pb-3">
        <span className="text-xs font-mono text-slate-400 uppercase block">Display Titles</span>
        <p className="text-xl font-display font-bold text-slate-900 mt-1">Large Display Heading</p>
       </div>
       <div>
        <span className="text-xs font-mono text-slate-400 uppercase block">Monospace/Labels</span>
        <p className="text-xs font-mono text-slate-500 font-bold uppercase mt-1">TRACKING_CODE_REF_9902</p>
       </div>
      </div>
     </div>
