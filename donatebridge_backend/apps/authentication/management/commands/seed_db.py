...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        Profile.objects.get_or_create(user=admin_user, phone='1112223334', address='Central Admin Office')
        ...
        ngo1 = NGO.objects.create(
            ...
            address='123 NGO Hub, Bandra East, Mumbai, MH, 400051',
            ...
            state='Maharashtra', district='Mumbai Suburban', city='Mumbai', pin_code='400051',
        ...
        ngo2 = NGO.objects.create(
            ...
            address='45 Eco Park, Shivajinagar, Pune, MH, 411005',
            ...
            state='Maharashtra', district='Pune', city='Pune', pin_code='411005',
        ...
        job = LogisticsJob.objects.create(
            donation=d2, carrier_name='Express Cargo #DB-990', current_step=4,
