...
const INITIAL_DONATIONS = [
  ...
  },
  {
    ...
    photos: ["https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=400"],
  ...
  },
  {
    ...
    photos: ["https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=400"],
  ...
  },
  {
    ...
    condition: "Like New",
    quantity: 8,
    description: "Advanced Calculus and Physics Study Guides. Perfect condition textbook set for college freshmen. Includes practice exams.",
    photos: ["https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=400"],
    location: { lat: 12.9634, lng: 77.5878, address: "Jayanagar 4th Block, Bengaluru" },
    status: "VERIFIED",
  ...
  },
  {
    ...
    condition: "Like New",
    quantity: 15,
    description: "Pack of 15 boys and girls navy blue school uniforms, hardly worn, washed and pressed.",
    photos: ["https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=400"],
    location: { lat: 12.9550, lng: 77.6105, address: "Koramangala, Bengaluru" },
    status: "VERIFIED",
    submittedAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
    reviewedAt: new Date().toISOString()
  },
  {
    ...
    condition: "New",
    quantity: 10,
    description: "10kg bags of premium basmati rice and yellow lentils. Completely sealed and hygienic.",
    photos: ["https://images.unsplash.com/photo-1586201375761-83865001e31c?w=400"],
    location: { lat: 12.9801, lng: 77.6012, address: "Indiranagar, Bengaluru" },
    status: "VERIFIED",
    submittedAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
    reviewedAt: new Date().toISOString()
  },
  {
    ...
    condition: "Good",
    quantity: 6,
    description: "Solid wood study desks suitable for classroom or community center learning. Sturdy and well-maintained.",
    photos: ["https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=400"],
    location: { lat: 12.9910, lng: 77.5920, address: "Hebbal, Bengaluru" },
    status: "VERIFIED",
    submittedAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(),
    reviewedAt: new Date().toISOString()
  },
  {
    ...
    condition: "Like New",
    quantity: 12,
    description: "8-inch screen learning tablets preloaded with educational applications. Minimal usage, scratch-free.",
    photos: ["https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?w=400"],
    location: { lat: 12.9340, lng: 77.6100, address: "HSR Layout, Bengaluru" },
    status: "VERIFIED",
    submittedAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
    reviewedAt: new Date().toISOString()
  },
  {
    ...
    condition: "New",
    quantity: 10,
    description: "Digital Upper Arm Blood Pressure Monitors. Automatic cuffs, brand new in box with batteries.",
    photos: ["https://images.unsplash.com/photo-1581594693702-fbdc51b2763b?w=400"],
    location: { lat: 12.9850, lng: 77.5850, address: "Vasanth Nagar, Bengaluru" },
    status: "VERIFIED",
    submittedAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
    reviewedAt: new Date().toISOString()
  },
  {
    ...
    condition: "New",
    quantity: 100,
    description: "Elementary School Stationery Packs containing notebooks, pencils, erasers, sharpeners, and crayons.",
    photos: ["https://images.unsplash.com/photo-1452860606245-08befc0ff44b?w=400"],
    location: { lat: 12.9980, lng: 77.5720, address: "Sadashivanagar, Bengaluru" },
    status: "VERIFIED",
    submittedAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
    reviewedAt: new Date().toISOString()
  },
  {
    ...
    condition: "New",
    quantity: 40,
    description: "Drawing Pads and Watercolor Packs. Art supply packets for students containing sketchbooks, paints, and brushes.",
    photos: ["https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=400"],
    location: { lat: 12.9720, lng: 77.6150, address: "Koramangala, Bengaluru" },
    status: "VERIFIED",
    submittedAt: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString(),
    reviewedAt: new Date().toISOString()
  },
  {
    ...
    condition: "New",
    quantity: 50,
    description: "Thermal Fleece Blankets. Double-layered polyester fleece blankets, lightweight yet extremely warm.",
    photos: ["https://images.unsplash.com/photo-1580301762395-21ce84d00bc6?w=400"],
    location: { lat: 12.9680, lng: 77.5920, address: "Richmond Town, Bengaluru" },
    status: "VERIFIED",
    submittedAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(),
    reviewedAt: new Date().toISOString()
  },
  {
    ...
    condition: "New",
    quantity: 15,
    description: "Football & Basketball Set. 10 leather soccer balls and 5 basketballs. Hand pumps and needles included.",
    photos: ["https://images.unsplash.com/photo-1584735935682-2f2b69dff9d2?w=400"],
    location: { lat: 12.9780, lng: 77.5620, address: "Rajajinagar, Bengaluru" },
    status: "VERIFIED",
    submittedAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
    reviewedAt: new Date().toISOString()
  },
  {
    ...
    condition: "Good",
    quantity: 16,
    description: "Badminton Rackets and Shuttlecocks. Youth-sized rackets with carry cases and nylon shuttlecock containers.",
    photos: ["https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?w=400"],
    location: { lat: 12.9980, lng: 77.6120, address: "Frazer Town, Bengaluru" },
    status: "VERIFIED",
    submittedAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
    reviewedAt: new Date().toISOString()
  }
