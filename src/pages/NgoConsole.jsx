    ...
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      ...
      <main className="flex-grow p-6 sm:p-8 space-y-8 max-w-7xl mx-auto w-full">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="bg-white border border-border p-6 rounded-2xl shadow-premium-sm flex justify-between items-center">
        ...
        {activeTab === 'needs' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            {/* Quick Add Need Form */}
            <div className="lg:col-span-4 bg-white border border-border p-8 rounded-2xl shadow-premium-sm space-y-6">
